...
- (void) setRightViewDelegate:(id<RightViewDelegate>)delegate {
...
- (NSMutableArray *)retrieveEquipmentsWithHasBeacon:(BOOL)withBeacon
{
    ...
    if (self.delegateRight != nil) {
        [self.delegateRight didGetDevicesInfo:szLocName indevices:[NSString stringWithFormat:@"%d", nInCount] withindevices:[NSString stringWithFormat:@"%d", nRoamingCount] requesteddevices:[NSString stringWithFormat:@"%d", nReturnCount] outdevices:[NSString stringWithFormat:@"%d", nOutCount]];
    }
