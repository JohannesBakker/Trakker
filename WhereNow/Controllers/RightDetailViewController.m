...
-(UIView *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *labelLevel = (UILabel *)[cell viewWithTag:103];
    UILabel *labelSN = (UILabel *)[cell viewWithTag:104];
    ...
    if (equip != nil)
    {
        ...
        if (equip.model_file_location) {
            __block UIActivityIndicatorView *activityIndicator;
            __weak UIImageView *weakImageView = imagePhoto;
            [imagePhoto sd_setImageWithURL:equip.model_file_location
